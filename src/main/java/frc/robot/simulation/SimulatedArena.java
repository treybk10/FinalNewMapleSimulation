...
import frc.robot.simulation.gamepieces.GamePiece;
...
import frc.robot.simulation.seasonspecific.rebuilt2026.Arena2026Rebuilt;
...
public abstract class SimulatedArena {
    ...
    private static Arena2026Rebuilt instance = null;
     ...
     */
    public static Arena2026Rebuilt getInstance() {
        ...
        if (instance == null) instance = new frc.robot.simulation.seasonspecific.rebuilt2026.Arena2026Rebuilt();
     ...
     */
    public static void overrideInstance(Arena2026Rebuilt newInstance) {
